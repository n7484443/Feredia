...
public class Map_tutorial_0 extends Map{
	...
	public void Init() throws IOException{
		...
		npc[0] = new NpcBase(0, height-32*7, 32, 32, new DialogueNpc("안녕하세요.", "제가 지금부터 조작 방법을 알려드릴게요.", "우선 'q'키를 눌러보세요."), new DialogueNpc("잘 하셨어요!", "대화는 이제 잘 아시겠죠?"),new DialogueNpc("점프는 '스페이스 바'로 하고요,","이동은 'a', 'd'키로 합니다."), new DialogueNpc("그리고 포탈을 들어가는 키는 'w'입니다."));
